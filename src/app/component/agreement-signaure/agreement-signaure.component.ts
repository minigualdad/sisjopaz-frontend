...
@Component({
  selector: 'app-agreement-signaure',
  standalone: false,
  templateUrl: './agreement-signaure.component.html',
  styleUrl: './agreement-signaure.component.scss'
})
export class AgreementSignaureComponent {
