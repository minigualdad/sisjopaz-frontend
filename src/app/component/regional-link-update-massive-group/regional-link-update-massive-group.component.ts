...
@Component({
  selector: 'app-regional-link-update-massive-group',
  standalone: false,
  templateUrl: './regional-link-update-massive-group.component.html',
  styleUrl: './regional-link-update-massive-group.component.scss'
})
export class RegionalLinkUpdateMassiveGroupComponent {
  ...
  getGroupInfo() {
    this.groupService.downloadGroupInfoByDivipola().subscribe({
        next: (response: Blob) => {
            ...
            a.href = url;
            a.download = 'Directorio_de_grupos.xlsx';
