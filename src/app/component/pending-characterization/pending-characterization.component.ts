...
@Component({
  selector: 'app-pending-characterization',
  standalone:false,
  templateUrl: './pending-characterization.component.html',
  styleUrl: './pending-characterization.component.scss'
})
export class PendingCharacterizationComponent {
