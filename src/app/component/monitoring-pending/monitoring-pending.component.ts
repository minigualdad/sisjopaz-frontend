...
@Component({
  selector: 'app-monitoring-pending',
  standalone:false,
  templateUrl: './monitoring-pending.component.html',
  styleUrl: './monitoring-pending.component.scss'
})
export class MonitoringPendingComponent {
